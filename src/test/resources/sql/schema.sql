...
CREATE TABLE IF NOT EXISTS CATEGORIES (
    ...
    CATEGORY_CREATED_TIME_STAMPS BIGINT DEFAULT (SELECT (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)),
    CATEGORY_UPDATED_TIME_STAMPS BIGINT DEFAULT (SELECT (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000))
);
...
CREATE TABLE IF NOT EXISTS PRODUCTS (
    ...
    PRODUCT_CREATED_TIME_STAMPS BIGINT DEFAULT (SELECT (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)),
    PRODUCT_UPDATED_TIME_STAMPS BIGINT DEFAULT (SELECT (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)),
